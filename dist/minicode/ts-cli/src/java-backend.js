...
export function javaMockRunTurnBackendArgs(options) {
...
export function javaRealRunBackendArgs(options) {
...
export function defaultRepoRoot(compiledMainUrl) {
    const mainPath = fileURLToPath(compiledMainUrl);
    return path.resolve(path.dirname(mainPath), "../../../..");
}
export function defaultDistRoot(compiledMainUrl) {
    const mainPath = fileURLToPath(compiledMainUrl);
...
export function minicodeJarPath(distRoot) {
    return path.resolve(distRoot, "lib", "minicode.jar");
}
export function resolveJavaCommand(env, fileExists = existsSync) {
